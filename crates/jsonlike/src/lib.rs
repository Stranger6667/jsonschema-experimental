...
impl<'a, T: Json> Json for &'a T
where
    &'a <T as Json>::Object: JsonObject<Value = &'a T>,
    &'a <T as Json>::Array: JsonArray<Element = &'a T>,
    &'a <T as Json>::String: PartialEq<str> + Eq + fmt::Debug + Borrow<str>,
    &'a <T as Json>::Number: for<'b> JsonNumber<'b>,
{
    type Object = &'a T::Object;
    type Array = &'a T::Array;
    type String = &'a T::String;
    type Number = &'a T::Number;
...
impl<'a, T: JsonNumber<'a>> JsonNumber<'a> for &'a T {
    type Integer = &'a T::Integer;
...
impl<'a, T: JsonArray> JsonArray for &'a T {
...
impl<'a, T: JsonObject> JsonObject for &'a T {
    type Key = T::Key;
